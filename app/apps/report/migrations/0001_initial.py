    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user_id"], name="report_repo_user_id_c947f1_idx"
                    ),
                    models.Index(
                        fields=["status"], name="report_repo_status_7d0999_idx"
                    ),
                    models.Index(fields=["type"], name="report_repo_type_cc67d0_idx"),
                    models.Index(
                        fields=["created_at"], name="report_repo_created_be46cb_idx"
                    ),
                ],
            },
        ),
